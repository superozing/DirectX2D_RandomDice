...
CRandomKnightBoss::CRandomKnightBoss()
	: CBossScript(RANDOMKNIGHTBOSS)
{
	...
	tInfo.MonTex = TEX_LOAD(L"texture\\Enemy\\Boss\\boss_3.png");
...
CRandomKnightBoss::CRandomKnightBoss(const CRandomKnightBoss& _Origin)
...
void CRandomKnightBoss::BossSkill()
{
}

void CRandomKnightBoss::begin()
{
	CEnemyScript::begin();
}

void CRandomKnightBoss::tick()
{
	CEnemyScript::tick();
